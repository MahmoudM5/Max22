...
sendMsg(msg.chat_id_,msg.id_,'❍ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس فاست يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
if Black == 'welcome on' or Black == 'تفعيل الفاست تيم' then
if redis:get(black..'welc'..msg.chat_id_) == 'on' then
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفاست تيم سابقا')
else
sendMsg(msg.chat_id_,msg.id_,'تم تفعيل الفاست تيم')
redis:set(black..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل تيم الفاست' then
if redis:get(black..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل تيم الفاست سابقا')
redis:set(black..'welc'..msg.chat_id_,'off')
redis:del(black..'welc'..msg.chat_id_,'on')
else
sendMsg(msg.chat_id_,msg.id_,'تم الفاست الترحيب')
end
end
...
{"تفعيل الفاست تيم","تعطيل تيم الفاست"},
