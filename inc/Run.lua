...
echo -e "\e[38;5;77m       •{ SOURCE fast source has been installed }•\e[0m"
echo -e "\e[38;5;77m       •{ developer 7oda : @MahmoudM2  }•\e[0m"

echo -e "\e[38;5;77m      BLANK ✾ @MahmoudM2[0m"
echo -e "\e[38;5;77m       ✾تم تطوير وبرمجة السورس من قبل 7oda ✾ .e[0m"
echo -e "\e[38;5;77m       ✾ @MahmoudM2[0m"
-------------------------------------------------------------------
]]..'\027[0;32m')
create_config() 
else
...
print('\27[0;33m>>'..[[
echo -e "\e[38;5;77m       •{ تنصيب سورس فاست بنسبه 100% ]  }•\e[0m"
echo -e "\e[38;5;77m       •{ •{ Join the Source Channel : @UP_II }• }•\e[0m"
...
if msg.sender_user_id_ == 1499701425 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1


elseif msg.sender_user_id_ == 1593178008 then 
msg.TheRank =  ' مطور حودا '
msg.Rank = 1
...
• قنـاة سورس فاست  ⇐ @otlop12. مـعرف المطور  :]]..SUDO_USER:gsub([[\_]],'_')..[[ .
]])
return false
end
if not msg then
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURC')
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE')
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE BLA')
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/MahmoudM5/Max22/main/plugins/games.lua','./plugins/games.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'SOURCE FAST\n\n• ** السورس الى اصدار \n• ** تم اعاده تشغيل سورس فاست بنجاح')
	dofile("./inc/Run.lua")
