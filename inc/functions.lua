...
─────▀██▀─────
│𝐒𝐸𝐿𝐴 ‿ @MahmoudM2
تم تطوير وبرمجة السورس من قبل حودا  ☆
│@MahmoudM2 ☆‿☆  
-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(fast..":NameBot:")
...
var =  'مالك السورس'
elseif  UserID == 1602018563 then
var =  'التوب'
elseif  UserID == 1499701425 then
var =  'مطور السورس'
elseif redis:sismember(fast..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(fast..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(fast..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(fast..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(fast..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(fast..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(fast..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(fast..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(fast..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(fast..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(fast..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(fast..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(fast..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(fast..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(fast..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(fast..':SUDO_BOT:')
message = '⌘♡  قائمه الـمـطـوريـن : \n\n`⌘مطور اساسي`♡ \n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(fast..'username:'..v)
local count = redis:scard(fast..'mtwr_count'..v)
...
local monsha = redis:smembers(fast..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⌘قائمه المدراء :*\n\n'
local list = redis:smembers(fast..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(fast..'admins:'..msg.chat_id_)
...
local list = redis:smembers(fast..'whitelist:'..msg.chat_id_)
...
if redis:sismember(fast..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(fast..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(fast..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(fast..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(fast..'gban_users')
...
local list = redis:smembers(fast..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(fast..':Filter_Word:'..msg.chat_id_,word) then 
return  "⌘♡ الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(fast..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(fast..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(fast..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(fast..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(fast..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(fast..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(fast..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(fast..'group:ids')
message = '⌘♡ قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(fast..'group:name'..v)
if info then 
...
redis:del(
fast..'group:add'..id_group,
fast..'lock_link'..id_group, 
fast..'lock_id'..id_group,
fast..'lock_spam'..id_group, 
fast..'lock_webpage'..id_group,
fast..'lock_markdown'..id_group,
fast..'lock_flood'..id_group,
fast..'lock_bots'..id_group,
fast..'mute_forward'..id_group,
fast..'mute_contact'..id_group,
fast..'mute_location'..id_group,
fast..'mute_document'..id_group,
fast..'mute_keyboard'..id_group,
fast..'mute_game'..id_group,
fast..'mute_inline'..id_group,
fast..'lock_username'..id_group,
fast..'num_msg_fast'..id_group,
fast..'replay'..id_group
)
redis:srem(fast..'group:ids',id_group)
end
...
redis:hset(fast..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(fast..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(fast..'group:add'..msg.chat_id_) then  return '⌘♡ المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(fast..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(fast..':addnumberusers') or 0)
...
local lock_service = redis:get(fast..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(fast..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(fast..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
fast..'group:add'..msg.chat_id_,true,
fast..'lock_link'..msg.chat_id_,true, 
fast..'lock_id'..msg.chat_id_,true,
fast..'lock_spam'..msg.chat_id_,true,
fast..'lock_webpage'..msg.chat_id_,true,
fast..'lock_markdown'..msg.chat_id_,true,
fast..'lock_flood'..msg.chat_id_,true,
fast..'lock_bots'..msg.chat_id_,true,
fast..'mute_forward'..msg.chat_id_,true,
fast..'mute_contact'..msg.chat_id_,true,
fast..'mute_location'..msg.chat_id_,true,
fast..'mute_document'..msg.chat_id_,true,
fast..'mute_keyboard'..msg.chat_id_,true,
fast..'mute_game'..msg.chat_id_,true,
fast..'mute_inline'..msg.chat_id_,true,
fast..'lock_username'..msg.chat_id_,true,
fast..'num_msg_fast'..msg.chat_id_,5, 
fast..'replay'..msg.chat_id_,true
)

redis:sadd(fast..'group:ids',msg.chat_id_) 
redis:sadd(fast..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(fast..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(fast..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(fast..'group:add'..msg.chat_id_) then return '♡  المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(fast..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID,'username',Resolv)
redis:sadd(fast..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(fast..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(fast..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(fast..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID,'username',Resolv)
redis:sadd(fast..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(fast..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(fast..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(fast..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(fast..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(fast..'whitelist:'..ChatID,UserID)
...
if redis:sismember(fast..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..'owners:'..ChatID,UserID)
...
if redis:sismember(fast..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(fast..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(fast..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(fast..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(fast..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(fast..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(fast..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(fast..'banned:'..ChatID,UserID)
...
if redis:sismember(fast..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(fast..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(fast..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(fast..'username:'..UserID, 'username',Resolv)
redis:sadd(fast..'gban_users',UserID)
...
redis:srem(fast..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء حظره العام \n',17,USERCAR) 
end
...
if redis:sismember(fast..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(fast..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(fast..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
redis:hset(fast..'username:'..UserID, 'username', UserName)
redis:sadd(fast..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(fast..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⌘♡ العضو » ❪ '..UserName..' ❫\n⌘♡ الايدي » ❪ `'..UserID..'` ❫\n⌘♡ تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المطور\n") 
elseif
redis:sismember(fast..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(fast..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المدير\n") 
elseif redis:sismember(fast..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(fast..'username:'..UserID, 'username', Resolv)
redis:sadd(fast..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(fast..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(fast..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⌘♡ العضو » '..USERNAME..' \n⌘♡  الايدي » (`'..UserID..'`)\n⌘♡ انه بالتأكيد ليس مطور \n') end
redis:srem(fast..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(fast..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(fast..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(fast..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(fast..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⚘*` اعدادات المجموعه :` \n"
.."\n⌘التعديل «» "..(redis:get(fast..'lock_edit'..msg.chat_id_) or 'false')
.."\n⌘الروابط «» "..(redis:get(fast..'lock_link'..msg.chat_id_) or 'false')
.."\n⌘التاك «» "..(redis:get(fast..'lock_tag'..msg.chat_id_) or 'false')
.."\n⌘المعرفات «» "..(redis:get(fast..'lock_username'..msg.chat_id_) or 'false')
.."\n⌘التكرار «» "..(redis:get(fast..'lock_flood'..msg.chat_id_) or 'false')
.."\n⌘الكلايش «» "..(redis:get(fast..'lock_spam'..msg.chat_id_) or 'false')
.."\n⌘الويب «» "..(redis:get(fast..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⌘الماركدوان «» "..(redis:get(fast..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⌘بالطرد البوتات «» "..(redis:get(fast..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⌘البوتات «» "..(redis:get(fast..'lock_bots'..msg.chat_id_) or 'false')
.."\n⌘عدد التكرار «» "..(redis:get(fast..'num_msg_fast'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚘`اعدادات الوسائط :`\n"
.."\n*⌘*المتحركه «» "..(redis:get(fast..'mute_gif'..msg.chat_id_) or 'false')
.."\n⌘الدردشه «» "..(redis:get(fast..'mute_text'..msg.chat_id_) or 'false')
.."\n⌘الانلاين «» "..(redis:get(fast..'mute_inline'..msg.chat_id_) or 'false')
.."\n⌘الالعاب «» "..(redis:get(fast..'mute_game'..msg.chat_id_) or 'false')
.."\n⌘الصور «» "..(redis:get(fast..'mute_photo'..msg.chat_id_) or 'false')
.."\n⌘الفيديو «» "..(redis:get(fast..'mute_video'..msg.chat_id_) or 'false')
.."\n⌘البصمات «» "..(redis:get(fast..'mute_audio'..msg.chat_id_) or 'false')
.."\n⌘الصوت «» "..(redis:get(fast..'mute_voice'..msg.chat_id_) or 'false')
.."\n⌘الملصقات «» "..(redis:get(fast..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⌘الجهات «» "..(redis:get(fast..'mute_contact'..msg.chat_id_) or 'false')
.."\n⌘التوجيه «» "..(redis:get(fast..'mute_forward'..msg.chat_id_) or 'false')
.."\n⌘الموقع «» "..(redis:get(fast..'mute_location'..msg.chat_id_) or 'false')
.."\n⌘الملفات «» "..(redis:get(fast..'mute_document'..msg.chat_id_) or 'false')
.."\n⌘الاشعارات «» "..(redis:get(fast..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⌘الكيبورد «» "..(redis:get(fast..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚘*`اعدادات اخرى : `"
.."\n\n*⚘*الترحيب «» "..welcomex
.."\n*⚘*الردود «» "..replayx
...
.."\n*⚘*الويب «» "..(redis:get(fast..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚘*الماركدوان «» "..(redis:get(fast..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⚘*البوتات بالطرد «» "..(redis:get(fast..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⚘*البوتات «» "..(redis:get(fast..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⚘*عدد التكرار «» "..(redis:get(fast..'num_msg_fast'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚘*اعدادات التقـييد :\n"
.."\n*⚘*التقييد بالتوجيه «» "..(redis:get(fast..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالصور «» "..(redis:get(fast..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالروابط «» "..(redis:get(fast..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالمتحركه «» "..(redis:get(fast..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد الفيديو «» "..(redis:get(fast..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
