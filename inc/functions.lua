...
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور حودا\n") 
...
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم مطور حودا\n") 
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور حودا\n")  
elseif UserID == 14322 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 14222 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 14227 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المطور\n") 
end
...
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور حودا\n") 
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد مطور حودا\n") 
elseif UserID == 14322 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد مطور السورس\n") 
elseif UserID == 14222 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد مطور السورس\n") 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1593178008 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك مطور السورس\n")  
elseif UserID == 1499701425 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور حودا\n") 
elseif UserID == 14322 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
